...
def parse_hadith_page(soup, islmwy_page = '', is_thaskeel = False):
    """
    ...
    for k, child in enumerate(container.children):
        ...
        if isinstance(child, NavigableString):
            ...
            # print(haddathana, clean_text(child))
            ...
            if hadith_number == 0:
                ...
                if( classes and 'hadith' in classes) or ( classes and 'mainsubj' in classes):
    ...
    if text:
        ...
        h_wa_haddathana = get_h_wa_haddathana_count_occurrences(text)
