                ...
                if narrator:
                    ...
                    if child.previous_sibling:
                        if isinstance(child.previous_sibling, Tag):
                            ...
                            text_before = clean_text(child.previous_sibling.strip())
                    ...
                    if child.next_sibling:
                        if isinstance(child.next_sibling, Tag):
                            ...
                            text_after = clean_text(child.next_sibling.strip())
                    ...
                    pickle_file = 'narrators_thaskeel' if is_thaskeel else 'narrators'
                    ...
                    if success:
                        print(f"Chapter updated {pickle_file} successfully.")
                    else:
