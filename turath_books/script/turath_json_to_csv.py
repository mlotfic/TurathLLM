...
def get_footer(text, book_id, page_id=2):
    """
...
def get_page_structure(text, book_id, page_id=2):
    """
    ...
    for i, match in enumerate(matches):
        ...
        if span_tag:
            ...
            match_id = re.search(r'\d+', span_tag['id'])
...
def get_structure_data_from_book_json(data, book_id_file):
    ...
    headings_processed_data.append(processed_sections)
    section_pages_data.append(section_pages)
    ...
    for page in pages:
        ...
        page_structure = get_page_structure(text, book_id, page_number)
